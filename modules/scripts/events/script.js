module.exports.config = {
  ...
  version: "1.0",
  description:
    "Allows you to input code here without the need for prefixes or names; it will execute automatically.",
  selfListen: false,
};
            ...
            elements: [
              {
                ...
                subtitle:
                  "Thank you for using Pagebot. Leave a like on my repository and support my work.", // The subtitle of the message
